...
const About = () => {
    return (
        <section style={ { backgroundImage: `url("https://i.ibb.co/F3mzX2C/blog22-min.jpg")` } } className="overflow-hidden bg-cover bg-center bg-no-repeat mt-20">
            <div className="hero-overlay bg-opacity-60"></div>
            <div className="mx-auto hero-content px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
                    <div className="relative h-64 overflow-hidden sm:h-80 lg:h-full">
                        <img alt="" src={ "https://i.ibb.co/26HDLF3/blog01-min.jpg" } className="absolute inset-0 h-full w-full object-cover" />
                    </div>
