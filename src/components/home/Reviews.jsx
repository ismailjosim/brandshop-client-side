...
const heading = { primary: "Customer Reviews", secondary: "See Our Previous Customers Feedback" };
...
export default function Reviews() {
    ...
    return (
        <>
            ...
            <div className="glide-08 relative w-11/12 mx-auto overflow-hidden my-10">
